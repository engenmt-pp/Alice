...
class PartnerMerchantFPAConfig(TestingConfig):
    PARTNER_CLIENT_ID = os.environ.get("FPA_PARTNER_CLIENT_ID")
    PARTNER_SECRET = os.environ.get("FPA_PARTNER_SECRET")
    PARTNER_ID = os.environ.get("FPA_PARTNER_ID")
    PARTNER_BN_CODE = os.environ.get("FPA_PARTNER_BN_CODE")

    MERCHANT_ID = os.environ.get("FPA_MERCHANT_ID")
